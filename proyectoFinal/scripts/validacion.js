    ...
    for (let elemento of entradasRequeridas) {
        elemento.onfocus = function () {
            this.style.backgroundColor = 'rgb(211, 252, 171)';
        }
    }
    ...
    formulario.onsubmit = function (event) {
        ...
        if (error) {
            ...
            mensajeError.textContent = "Debes llenar todos los campos marcados como obligatorios. (*)";
        }
    }
    ...
    document.getElementById("cancelar").addEventListener("click", function () {
        document.querySelectorAll(".requerido").forEach(function (elemento) {
          elemento.value = "";  
        });
      });      